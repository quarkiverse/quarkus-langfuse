...
public interface QuarkusUnstableDashboardWidgetsAsyncApi
        extends com.langfuse.api.unstableDashboardWidgets.async.UnstableDashboardWidgetsApi {
    ...
    CompletionStage<UnstableDashboardWidget> unstableDashboardWidgetsCreate(
     ...
     */
    @Override
    default CompletionStage<UnstableDashboardWidget> unstableDashboardWidgetsCreate(
    ...
    @Produces(MediaType.APPLICATION_JSON)
    CompletionStage<UnstableDeleteDashboardWidgetResponse> unstableDashboardWidgetsDelete(
     ...
     */
    @Override
    default CompletionStage<UnstableDeleteDashboardWidgetResponse> unstableDashboardWidgetsDelete(
    ...
    @Path("/api/public/unstable/dashboard-widgets/{widgetId}")
    @Produces(MediaType.APPLICATION_JSON)
    CompletionStage<UnstableDashboardWidget> unstableDashboardWidgetsGet(
            @PathParam("widgetId") String widgetId);
     ...
     */
    @Override
    default CompletionStage<UnstableDashboardWidget> unstableDashboardWidgetsGet(
    ...
    @Path("/api/public/unstable/dashboard-widgets")
    @Produces(MediaType.APPLICATION_JSON)
    CompletionStage<UnstableDashboardWidgetList> unstableDashboardWidgetsList(
     ...
     */
    @Override
    default CompletionStage<UnstableDashboardWidgetList> unstableDashboardWidgetsList(
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    CompletionStage<UnstableDashboardWidget> unstableDashboardWidgetsUpdate(
            @PathParam("widgetId") String widgetId,
     ...
     */
    @Override
    default CompletionStage<UnstableDashboardWidget> unstableDashboardWidgetsUpdate(

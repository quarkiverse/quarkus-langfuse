...
/**
 * Langfuse Scores V3 API
 */
public interface QuarkusScoresV3Api extends com.langfuse.api.scoresV3.ScoresV3Api {
    ...
    GetScoresV3Response scoresV3GetManyV3(
     ...
     */
    @Override
    default GetScoresV3Response scoresV3GetManyV3(APIScoresV3GetManyV3Request apiRequest) {

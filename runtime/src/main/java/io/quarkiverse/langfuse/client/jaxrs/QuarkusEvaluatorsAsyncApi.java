...
/**
 * Langfuse Evaluators Async API
 */
public interface QuarkusEvaluatorsAsyncApi extends com.langfuse.api.evaluators.async.EvaluatorsApi {
    ...
    CompletionStage<Evaluator> evaluatorsCreate(
     ...
     */
    @Override
    default CompletionStage<Evaluator> evaluatorsCreate(APIEvaluatorsCreateRequest apiRequest) {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    CompletionStage<DeletedEvaluator> evaluatorsDelete(
     ...
     */
    @Override
    default CompletionStage<DeletedEvaluator> evaluatorsDelete(APIEvaluatorsDeleteRequest apiRequest) {
    ...
    @Path("/api/public/v2/evaluators/{evaluatorId}")
    @Produces(MediaType.APPLICATION_JSON)
    CompletionStage<Evaluator> evaluatorsGet(
            @PathParam("evaluatorId") String evaluatorId);
     ...
     */
    @Override
    default CompletionStage<Evaluator> evaluatorsGet(APIEvaluatorsGetRequest apiRequest) {
    ...
    @Path("/api/public/v2/evaluators")
    @Produces(MediaType.APPLICATION_JSON)
    CompletionStage<EvaluatorsPage> evaluatorsList(
     ...
     */
    @Override
    default CompletionStage<EvaluatorsPage> evaluatorsList(APIEvaluatorsListRequest apiRequest) {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    CompletionStage<EvaluatorVersionsPage> evaluatorsListVersions(
            @PathParam("evaluatorId") String evaluatorId,
            @QueryParam("limit") Integer limit,
            @QueryParam("cursor") String cursor);
     ...
     */
    @Override
    default CompletionStage<EvaluatorVersionsPage> evaluatorsListVersions(APIEvaluatorsListVersionsRequest apiRequest) {
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    CompletionStage<Evaluator> evaluatorsUpdate(
            @PathParam("evaluatorId") String evaluatorId,
     ...
     */
    @Override
    default CompletionStage<Evaluator> evaluatorsUpdate(APIEvaluatorsUpdateRequest apiRequest) {

...
/**
 * Langfuse Unstable Dashboards API
 */
public interface QuarkusUnstableDashboardsApi extends com.langfuse.api.unstableDashboards.UnstableDashboardsApi {
    ...
    UnstableDashboardPlacement unstableDashboardsAddPlacement(
     ...
     */
    @Override
    default UnstableDashboardPlacement unstableDashboardsAddPlacement(
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    UnstableDashboard unstableDashboardsCreate(
     ...
     */
    @Override
    default UnstableDashboard unstableDashboardsCreate(APIUnstableDashboardsCreateRequest apiRequest) {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    UnstableDeleteDashboardResponse unstableDashboardsDelete(
            @PathParam("dashboardId") String dashboardId);
     ...
     */
    @Override
    default UnstableDeleteDashboardResponse unstableDashboardsDelete(
    ...
    @Produces(MediaType.APPLICATION_JSON)
    UnstableDeleteDashboardPlacementResponse unstableDashboardsDeletePlacement(
            @PathParam("dashboardId") String dashboardId,
     ...
     */
    @Override
    default UnstableDeleteDashboardPlacementResponse unstableDashboardsDeletePlacement(
    ...
    @Path("/api/public/unstable/dashboards/{dashboardId}")
    @Produces(MediaType.APPLICATION_JSON)
    UnstableDashboard unstableDashboardsGet(
            @PathParam("dashboardId") String dashboardId);
     ...
     */
    @Override
    default UnstableDashboard unstableDashboardsGet(APIUnstableDashboardsGetRequest apiRequest) {
    ...
    @Path("/api/public/unstable/dashboards")
    @Produces(MediaType.APPLICATION_JSON)
    UnstableDashboardList unstableDashboardsList(
     ...
     */
    @Override
    default UnstableDashboardList unstableDashboardsList(APIUnstableDashboardsListRequest apiRequest) {
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    UnstableDashboard unstableDashboardsUpdate(
            @PathParam("dashboardId") String dashboardId,
     ...
     */
    @Override
    default UnstableDashboard unstableDashboardsUpdate(APIUnstableDashboardsUpdateRequest apiRequest) {
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    UnstableDashboardPlacement unstableDashboardsUpdatePlacement(
            @PathParam("dashboardId") String dashboardId,
            @PathParam("placementId") String placementId,
     ...
     */
    @Override
    default UnstableDashboardPlacement unstableDashboardsUpdatePlacement(

...
final class DefaultExperimentOperations extends AbstractCursorOperations<Experiment>
        implements ExperimentOperations {
    ...
    DefaultExperimentOperations(ExperimentsApi experimentsApi, LangfuseConfig config,
    ...
    private DefaultExperimentOperations(ExperimentsApi experimentsApi, LangfuseConfig config,
    ...
    @Override
    public ExperimentOperations matching(ExperimentFilter filter) {
        return new DefaultExperimentOperations(this.experimentsApi, this.config, this.fromStartTime,
                this.toStartTime, ValidationUtils.ensureNotNull(filter, "Filter"));
    }

    private static CursorResult<Experiment> fetch(ExperimentsApi experimentsApi, Cursor cursor,
            OffsetDateTime fromStartTime, OffsetDateTime toStartTime, ExperimentFilter filter) {
        var response = experimentsApi.experimentsList(request(cursor, fromStartTime, toStartTime, filter));

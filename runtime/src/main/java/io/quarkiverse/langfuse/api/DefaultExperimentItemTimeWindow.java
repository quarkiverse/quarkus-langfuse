...
record DefaultExperimentItemTimeWindow(ExperimentsApi experimentsApi, LangfuseConfig config)
        implements
            ExperimentItemTimeWindow {

    @Override
    public ExperimentItemOperations since(OffsetDateTime fromStartTime) {
        return new DefaultExperimentItemOperations(this.experimentsApi, this.config,
                ValidationUtils.ensureNotNull(fromStartTime, "From start time"), null);
    }

    @Override
    public ExperimentItemOperations between(OffsetDateTime fromStartTime, OffsetDateTime toStartTime) {
        ...
        return new DefaultExperimentItemOperations(this.experimentsApi, this.config, fromStartTime, toStartTime);
    }

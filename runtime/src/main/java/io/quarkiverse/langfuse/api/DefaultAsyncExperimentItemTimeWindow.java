...
record DefaultAsyncExperimentItemTimeWindow(ExperimentsApi experimentsApi, LangfuseConfig config)
        implements
            AsyncExperimentItemTimeWindow {

    @Override
    public AsyncExperimentItemOperations since(OffsetDateTime fromStartTime) {
        return new DefaultAsyncExperimentItemOperations(this.experimentsApi, this.config,
                ValidationUtils.ensureNotNull(fromStartTime, "From start time"), null);
    }

    @Override
    public AsyncExperimentItemOperations between(OffsetDateTime fromStartTime, OffsetDateTime toStartTime) {
        ...
        return new DefaultAsyncExperimentItemOperations(this.experimentsApi, this.config, fromStartTime, toStartTime);
    }

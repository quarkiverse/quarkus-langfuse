...
@QuarkusTest
class ScoresV3ApiTest {

    private static final String TRACE_ID = UUID.randomUUID().toString().replace("-", "");
    private static final String SCORE_NAME = "v3-test-score-" + UUID.randomUUID().toString().substring(0, 8);
    ...
    void setupTraceAndScore() {
        ...
        OtelTestHelper.ingestTrace(client, TRACE_ID, "scores-v3-test-trace");
    ...
    @Test
    @Order(2)
    void listScoresV3ContainsCreatedScore() {

 ...
 * this class shares no state with {@link OperationsTests} and creates every fixture it
 * needs.
 */
@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
@QuarkusTest
@TestProfile(SerialDeleteConcurrencyTests.SerialDeleteProfile.class)
class SerialDeleteConcurrencyTests {
